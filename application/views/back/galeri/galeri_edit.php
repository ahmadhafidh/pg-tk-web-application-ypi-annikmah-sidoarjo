          ...
          <div class="box box-primary">
            <div class="box-body">
              <div class="form-group"><label>Judul</label>
                <?php echo form_input($judul, $galeri->judul);?>
              </div>
              <div class="form-group"><label>Gambar Sebelumnya</label><br>
                <img src="<?php echo base_url('assets/images/galeri/'.$galeri->userfile.$galeri->userfile_type.'') ?>" width="200px"/>
              </div>
              <div class="form-group"><label>Gambar Baru</label>
                ...
                <img id="preview" src="" alt="" width="350px"/>
                      ...
                      <?php echo form_input($id_galeri,$galeri->id_galeri);?>
