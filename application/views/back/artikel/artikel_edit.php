      ...
      <?php echo form_open_multipart($action);?>
        ...
        <div class="col-md-6">
          <div class="box box-primary">
            <div class="box-body">
              <div class="form-group"><label>Judul Artikel</label>
                <?php echo form_input($judul_artikel, $artikel->judul_artikel);?>
              </div>
              <div class="form-group"><label>Isi Artikel</label>
                <?php echo form_textarea($isi_artikel,$artikel->isi_artikel);?>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-xs-4"><label>Kategori</label>
                  <?php echo form_dropdown('',$get_combo_kategori,$artikel->kategori,$kategori_css);?>
                </div>
              </div><br>
              
            </div>
            <?php echo form_input($id_artikel,$artikel->id_artikel);?>
...
theme_advanced_buttons2 : "formatselect,fontselect,fontsizeselect,insertfile,insertimage",z
