  ...
  <section class='content'>
    <div class='row'>
      <div class='col-lg-6 col-xs-6'>
        ...
        <div class='small-box bg-yellow'>
          <div class='inner'><h3> <?php echo $total_galeri ?> </h3><p>Galeri</p></div>
          <div class='icon'><i class='fa fa-newspaper-o'></i></div>
          <a href='<?php echo base_url('admin/galeri') ?>' class='small-box-footer'>Selengkapnya <i class='fa fa-arrow-circle-right'></i></a>
        </div>
