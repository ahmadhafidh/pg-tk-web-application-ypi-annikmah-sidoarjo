						...
						<div class="row">
										...
										<div class="vc_gitem-animated-block vc_gitem-animate vc_gitem-animate-scaleRotateIn" data-vc-animation="scaleRotateIn">
											<div class="vc_custom_heading vc_gitem-post-data vc_gitem-post-data-source-post_title">
												<h2 class="h2" style="text-align: left">
													<a href="<?php echo base_url('agenda?detail=').$agenda->id_agenda.'&&name='.$agenda->judul_seo; ?>" title="<?php echo $agenda->judul; ?>"><u><?php echo ucwords($agenda->judul); ?></u></a>
												</h2>
											</div>
											<div class="vc_gitem-zone vc_gitem-zone-a vc-gitem-zone-height-mode-auto vc-gitem-zone-height-mode-auto-4-3 vc_gitem-is-link" style="background-image: url('<?php echo base_url('assets/images/agenda/').$agenda->userfile.$agenda->userfile_type; ?>') !important;">
												<a href="<?php echo base_url('agenda?detail=').$agenda->id_agenda.'&&name='.$agenda->judul_seo; ?>" title="<?php echo $agenda->judul; ?>" class="vc_gitem-link vc-zone-link"></a>
												<img src="<?php echo base_url('assets/images/agenda/').$agenda->userfile.$agenda->userfile_type; ?>" class="vc_gitem-zone-img" alt="">
												...
												<div class="vc_gitem_row vc_row vc_gitem-row-position-top">
													<div class="vc_col-sm-12 vc_gitem-col vc_gitem-col-align-">
														...
														<div class="vc_btn3-container  read-more vc_btn3-left">
															<a href="<?php echo base_url('agenda?detail=').$agenda->id_agenda.'&&name='.$agenda->judul_seo; ?>" class="vc_gitem-link vc_general vc_btn3 vc_btn3-size-md vc_btn3-shape-rounded vc_btn3-style-flat vc_btn3-color-juicy-pink read-more" title="Read More">Read More</a>
														</div>
													</div>
												</div>
											</div>
									...
									<?php
										if($total_halaman > 7){
											if($halaman_sekarang != 1){
												echo '<a class="next page-numbers" href="'.base_url('agenda?page='.($halaman_sekarang - 1)).'"> Prev </a>';
											}
											for($i = 1; $i <= $total_halaman; $i++){
												if($i == $halaman_sekarang){
													...
													if($i < 5){
														echo "<a class='page-numbers' href='".base_url('agenda?page='.$i)."'>".$i."</a>";
											...
											if($halaman_sekarang != $total_halaman){
												echo '<a class="next page-numbers" href="'.base_url('agenda?page='.($halaman_sekarang + 1)).'"> Next </a>';
											}
										}else{
											if($halaman_sekarang != 1){
												echo '<a class="next page-numbers" href="'.base_url('agenda?page='.($halaman_sekarang - 1)).'"> Prev </a>';
							...
							<div class="category-sidebar-right col-lg-4 col-md-4 col-sm-4 ">
								<aside style="margin-top:0px;" id="search-3" class="widget widget_search sidebar-right">
									...
									<form method="get" class="search-form" action="http://www.zoutula.com/themes/kiddie/">
										<label>
								...
								<aside id="text-5" class="widget widget_text sidebar-right">
									...
									<div class="textwidget">
										At suas similique definitiones est, vim ea tempor perpetua. 
										Sale eripuit ponderum ne his, ad duis reque prodesset vis.
										<br /><br />
										<ul>
									...
									<div class="ztl-widget-recent-posts-container ztl-widget-recent-posts-3">
										...
										<div class="ztl-widget-recent-posts">
											<ul class="recent-posts ztl-list-reset">
												<!-- the loop -->
												<?php foreach ($agenda_dataRandom as $agenda): ?>
												<li class="item-post clearfix">
													<a href="<?php echo base_url('agenda?detail=').$agenda->id_agenda.'&&name='.$agenda->judul_seo; ?>" title="<?php echo $agenda->judul; ?>">
														...
														<?php echo base_url('assets/images/agenda/').$agenda->userfile.$agenda->userfile_type; ?>, 
														<?php echo base_url('assets/images/agenda/').$agenda->userfile.$agenda->userfile_type; ?>, 
														<?php echo base_url('assets/images/agenda/').$agenda->userfile.$agenda->userfile_type; ?>" 
