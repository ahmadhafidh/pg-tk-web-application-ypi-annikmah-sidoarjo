						...
						<div class="row">
									...
									<?php
										if($total_halaman > 7){
											if($halaman_sekarang != 1){
												if(isset($_GET['cari'])){
													echo '<a class="next page-numbers" href="'.base_url('agenda?cari='.$_GET['cari'].'&&page='.($halaman_sekarang - 1)).'"> Prev </a>';
												}else{
											...
											for($i = 1; $i <= $total_halaman; $i++){
												if($i == $halaman_sekarang){
													...
													if($i < 5){
														if(isset($_GET['cari'])){
															echo "<a class='page-numbers' href='".base_url('agenda?cari='.$_GET['cari'].'&&page='.$i)."'>".$i."</a>";
														}else{
											...
											if($halaman_sekarang != $total_halaman){
												if(isset($_GET['cari'])){
													echo '<a class="next page-numbers" href="'.base_url('agenda?cari='.$_GET['cari'].'&&?page='.($halaman_sekarang + 1)).'"> Next </a>';
												}else{
							...
							<div class="category-sidebar-right col-lg-4 col-md-4 col-sm-4 ">
								<aside style="margin-top:0px;" id="search-3" class="widget widget_search sidebar-right">
									...
									<form method="get" class="search-form" action="<?php echo base_url('agenda'); ?>">
										<label>
									...
									<div class="ztl-widget-recent-posts-container ztl-widget-recent-posts-3">
										...
										<div class="ztl-widget-recent-posts">
											<ul class="recent-posts ztl-list-reset">
												<!-- the loop -->
												<?php foreach ($dataRandom as $agenda): ?>
