						...
						<div class="row">
									...
									<div class="vc_grid-item-mini vc_clearfix">
										<div class="vc_gitem-animated-block vc_gitem-animate vc_gitem-animate-scaleRotateIn" data-vc-animation="scaleRotateIn">
											<div class="vc_custom_heading vc_gitem-post-data vc_gitem-post-data-source-post_title">
												<h3 class="h3" style="text-align: left"><b>
													<a href="<?php echo base_url('artikel?detail=').$artikel->id_artikel.'&&name='.$artikel->judul_artikel; ?>" title="<?php echo $artikel->judul_artikel; ?>"><u><?php echo ucwords($artikel->judul_artikel); ?></u></a>
												</b></h3>
											</div>
										</div>
										<div class="vc_gitem-zone vc_gitem-zone-c vc_custom_1467658963197" style="background-color:lavender;">
											<div class="vc_gitem-zone-mini">
												<div class="vc_gitem_row vc_row vc_gitem-row-position-top">
													<div class="vc_col-sm-12 vc_gitem-col vc_gitem-col-align-" style="padding-top:0px;">
														<div class="vc_custom_heading vc_gitem-post-data vc_gitem-post-data-source-post_excerpt">
															<?php
															$text = $artikel->isi_artikel;
									...
									<?php
										if($total_halaman > 7){
											if($halaman_sekarang != 1){
												if(isset($_GET['cari'])){
													echo '<a class="next page-numbers" href="'.base_url('artikel?cari='.$_GET['cari'].'&&page='.($halaman_sekarang - 1)).'"> Prev </a>';
												}else{
													echo '<a class="next page-numbers" href="'.base_url('artikel?page='.($halaman_sekarang - 1)).'"> Prev </a>';
												}
											}
											for($i = 1; $i <= $total_halaman; $i++){
												if($i == $halaman_sekarang){
													...
													if($i < 5){
														if(isset($_GET['cari'])){
															echo "<a class='page-numbers' href='".base_url('artikel?cari='.$_GET['cari'].'&&page='.$i)."'>".$i."</a>";
														}else{
															echo "<a class='page-numbers' href='".base_url('artikel?page='.$i)."'>".$i."</a>";
														}
											...
											if($halaman_sekarang != $total_halaman){
												if(isset($_GET['cari'])){
													echo '<a class="next page-numbers" href="'.base_url('artikel?cari='.$_GET['cari'].'&&?page='.($halaman_sekarang + 1)).'"> Next </a>';
												}else{
													echo '<a class="next page-numbers" href="'.base_url('artikel?page='.($halaman_sekarang + 1)).'"> Next </a>';
												}
											}
										}else{
											if($halaman_sekarang != 1){
							...
							<div class="category-sidebar-right col-lg-4 col-md-4 col-sm-4 ">
								<aside style="margin-top:0px;" id="search-3" class="widget widget_search sidebar-right">
									...
									<form method="get" class="search-form" action="<?php echo base_url('artikel'); ?>">
										<label>
									...
									<div class="ztl-widget-recent-posts-container ztl-widget-recent-posts-3">
										...
										<div class="ztl-widget-recent-posts">
											<ul class="recent-posts ztl-list-reset">
												<!-- the loop -->
												<?php foreach ($dataRandom as $artikel): ?>
												<li class="item-post clearfix">
													<h6>
														<a href="<?php echo base_url('artikel?detail=').$artikel->id_artikel.'&&name='.$artikel->judul_artikel; ?>" title="<?php echo $artikel->judul_artikel; ?>">
